...
for i in range(1, nrows):
    ...
    if cause == 'Social Welfare & Poverty Alleviation':
        alleviation.append(data)
    elif cause == 'Culture': culture.append(data)
    elif cause == 'Disaster Relief': disaster.append(data)
    elif cause == 'Education': education.append(data)
    elif cause == 'Environment': environment.append(data)
    elif cause == 'Public Health': health.append(data)
    elif cause == 'Unspecified': unspecified.append(data)
